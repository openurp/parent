...
object Dependencies {
  val beangle_commons_ver = "5.6.15"
  val beangle_jdbc_ver = "1.0.0"
  val beangle_data_ver = "5.8.9"
  val beangle_cdi_ver = "0.6.5"
  val beangle_web_ver = "0.4.11"
  val beangle_serializer_ver= "0.1.9"
  val beangle_cache_ver= "0.1.8"
  val beangle_template_ver ="0.1.12"
  val beangle_webmvc_ver="0.9.24"
  val beangle_security_ver="4.3.19"
  val beangle_ids_ver="0.3.16"
  val beangle_ems_ver="4.8.12"
  val beangle_doc_ver="0.3.3"
  ...
  val beangle_ids_cas = "org.beangle.ids" % "beangle-ids" % beangle_ids_ver
