...
object Dependencies {
  ...
  val beangle_ems_app = "org.beangle.ems" % "beangle-ems-app" % "4.15.8"
  ...
  val logback_classic = "ch.qos.logback" % "logback-classic" % "1.5.28"
  val logback_core = "ch.qos.logback" % "logback-core" % "1.5.28"
}
